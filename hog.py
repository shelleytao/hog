...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    cube = score * score * score
    alt_diff, n = 0, 1
    while cube >= 1:
        if n % 2 == 0:
            alt_diff = alt_diff - cube % 10
            cube = cube // 10
            n = n + 1
        else:
            alt_diff = alt_diff + cube % 10
...
def is_swap(player_score, opponent_score):
    ...
    e_last = excitement % 10
    while excitement > 0:
        e_first = excitement % 10
        excitement = excitement // 10
    return e_first == e_last
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        if who == 0:
            ...
            if feral_hogs:
                if is_swap(score0, score1) or is_swap(score1, score0):
                    score0, score1 = score1, score0
                    if abs(num_rolls0 - trace0) == 2:
                        bonus0 = 3
                    score0, score1 = score1, score0
                else:
                    if abs(num_rolls0 - trace0) == 2:
                        bonus0 = 3
            trace0 = take_turn(num_rolls0, score1, dice)
            score0 = score0 + trace0 + bonus0
        else:
            num_rolls1 = strategy1(score1, score0)
            if feral_hogs:
                if is_swap(score0, score1) or is_swap(score1, score0):
                    score0, score1 = score1, score0
                    if abs(num_rolls1 - trace1) == 2:
                        bonus1 = 3
                    score0, score1 = score1, score0
                else:
                    if abs(num_rolls1 - trace1) == 2:
                        bonus1 = 3
            trace1 = take_turn(num_rolls1, score0, dice)
            score1 = score1 + trace1 + bonus1
        if is_swap(score0, score1) or is_swap(score1, score0):
            score0, score1 = score1, score0
        who = other(who)
    # END PROBLEM 5
...
def announce_highest(who, prev_high=0, prev_score=0):
    ...
    def say(score0, score1):
        ...
        if who == 1:
            ...
            if prev_high < diff:
                print(diff, "point(s)! That's the biggest gain yet for Player", who)
        return announce_highest(who, max(prev_high, diff), score(who))
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_rolls < 11:
        ...
        score = average_score(num_rolls, dice)
        if score > max_score:
            max_score = score
